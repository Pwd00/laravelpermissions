                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{route('articles.store')}}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-2">
                                <input type="text" value="{{old(key: 'desc')}}" placeholder="Enter Title" name="title" id="title" class="bg-grey-300 shadow-md w-1/2 rounded-lg text-black">
                                @error('title')
                            ...
                            <div class="my-2">
                                <textarea name="text" id="text" class="bg-grey-300 shadow-md w-1/2 rounded-lg text-black placeholder:text-rose-300" placeholder="Enter Description"></textarea>
                                @error('text')
                            ...
                            <div class="my-2">
                                <input type="text" name="author" id="author" class="bg-grey-300 shadow-md rounded-lg text-black w-1/2" placeholder="Enter Author name ">
                            </div>
                            @error('author')
