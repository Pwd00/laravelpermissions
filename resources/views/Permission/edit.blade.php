                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{route('permission.update',[$permission->id])}}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-2">
                                <input type="text"  value="{{old('name',$permission->name)}}" placeholder="Enter Permissions" name="name" id="name" class="bg-grey-300 shadow-md w-1/2 rounded-lg text-black">
                            </div>
                            @error('name')
